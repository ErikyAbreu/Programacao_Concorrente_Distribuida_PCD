 ...
 *           a message.
 *
 * Compile:  mpicc -g -Wall -o mpi_vector_42 mpi_vector_42.c -lm
 * Usage:    mpiexec -n<number of processes> ./mpi_vector_42
 *
 * Input:    None
...
int main(void) {
   ...
   Read_vector(local_vector_1, vector_send, vector_display, local_n_vector, n_vector, "ONE", my_rank, MPI_COMM_WORLD);

   Print_vector(local_vector_1, vector_send, vector_display, local_n_vector, n_vector, "ONE", my_rank, MPI_COMM_WORLD);
   ...
   Print_vector(local_vector_1, vector_send, vector_display, local_n_vector, n_vector, "THE VECTOR ONE MULTIPLIED BY THE SCALAR", my_rank, MPI_COMM_WORLD);

   //START VECTOR TWO
   Allocate_vector(&local_vector_2, local_n_vector, MPI_COMM_WORLD);

   Read_vector(local_vector_2, vector_send, vector_display, local_n_vector, n_vector, "TWO", my_rank, MPI_COMM_WORLD);

   Print_vector(local_vector_2, vector_send, vector_display, local_n_vector, n_vector, "TWO", my_rank, MPI_COMM_WORLD);
